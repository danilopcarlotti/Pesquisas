...
def encontra_string_semelhante(lista_nomes, stringAnalisada, nCaracteres):
    ...
    if nCaracteres:
        for item in lista_nomes:
            ratio_s = jellyfish.jaro_distance(
                stringAnalisada[:nCaracteres], item[:nCaracteres]
            )
        ...
        if maior_semelhanca > 0.7:
            ...
            return encontra_string_semelhante(
                lista_nomes, stringAnalisada, nCaracteres - 15
            )
    else:
        return "Outros"
