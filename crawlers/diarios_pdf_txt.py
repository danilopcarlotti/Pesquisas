...
re_diarios = [
	...
	[r".+MT\.pdf$",arq_mt],
	[r".+SE\.pdf$",arq_se],
	[r"^Diário.*?.pdf$",arq_trf5],
	[r".+STJ\.pdf$",arq_stj],
	[r"\d.+TRF1\.pdf$",arq_trf1],
	[r"\d+GO\.pdf$",arq_go],
	[r"^Diario_\d{4}_.+\.pdf$",arq_trt],
	[r"^tjapDJE.+\.pdf$",arq_ap],
	[r".+RN\.pdf$",arq_rn],
	[r"^de_jud_"+ano+mes+dia+"\d+.+\.pdf$",arq_trf4],
	[r"^de_[jJ]ud.+TRF.+\.pdf$",arq_trf3],
	[r"^DE"+ano+mes+dia+"\.pdf$",arq_ac],
	[r"^Diário da Justi.+\.pdf$",arq_pr],
	[r"^diario_\d+_cad.+\.pdf$",arq_sc],
	[r"^caderno\d-Judicial.+\.pdf$",arq_sp],
	[r"^Caderno\d-Jurisdicional.+\.pdf$",arq_al],
	[r"^Caderno\d-Judiciario.+\.pdf$",arq_am],
	[r"^Caderno4.+\.pdf$",arq_am],
	[r"^caderno2-Judiciario\.pdf$",arq_ce],
	[r"^Caderno\d-Judicial.+\.pdf$",arq_ms],
	[r"^\d+\.pdf$",arq_rs],
	[r"^diario_\d+-\d+-\d+\.pdf$",arq_pb],
	[r"^bahia.pdf$",arq_ba],
	[r"^riodejaneiro\d+.pdf$",arq_rj],
