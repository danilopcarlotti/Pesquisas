...
class crawler_jurisprudencia_tjpa:
    ...
    def __init__(self):
        ...
        self.botao_pesquisar_avancado = (
            '//*[@id="advancedForm"]/div[1]/div[1]/div/span/button'
        )
        self.botao_proximo_iniXP = (
            '//*[@id="resultados"]/div/div[1]/div[2]/div/span[1]/a'
        )
    ...
    def parser_acordaos(self, texto, cursor):
        ...
        cursor.execute(
            ...
            % ("pa", numero, data_disponibilizacao, orgao_julgador, julgador, texto)
        )
