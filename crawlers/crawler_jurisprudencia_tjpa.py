...
class crawler_jurisprudencia_tjpa():
	...
	def __init__(self):
		...
		self.link_inicial = 'http://www.tjpa.jus.br/PortalExterno/institucional/Acordaos-e-Jurisprudencia/'
		...
		self.botao_pesquisar_avancado = '//*[@id="advancedForm"]/div[4]/div[6]/div/div/button[2]'
