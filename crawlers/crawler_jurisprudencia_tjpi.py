...
class crawler_jurisprudencia_tjpi(crawler_jurisprudencia_tj):
    ...
    def __init__(self):
        ...
        self.botao_pesquisar = (
            '//*[@id="wrapper"]/div/div[2]/div/div[1]/div/form/fieldset/div/div/button'
        )
    ...
    def download_diario_retroativo(self, data_especifica=None):
        ...
        if data_especifica:
            ...
            try:
                ...
                subprocess.Popen(
                    "mkdir %s/Diarios_pi/%s" % (path_hd, data_especifica), shell=True
                )
                subprocess.Popen(
                    "mv %s/*.pdf %s/Diarios_pi/%s" % (path, path_hd, data_especifica),
                    shell=True,
                )
