...
class crawler_jurisprudencia_tjgo:
    ...
    def parser_acordaos(self, texto, cursor):
        ...
        cursor.execute(
            'INSERT INTO jurisprudencia_2_inst.jurisprudencia_2_inst (tribunal, numero, data_decisao, julgador, polo_ativo, polo_passivo, texto_decisao) values ("%s","%s","%s","%s","%s","%s","%s");'
            % (
                "go",
                numero,
