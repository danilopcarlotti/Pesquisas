...
class crawler_jurisprudencia_tjsp(crawler_jurisprudencia_tj):
	...
	def __init__(self):
		...
		self.tabela_colunas = 'justica_estadual.jurisprudencia_sp_societario (ementas)'
...
def main():
	...
	crawler_jurisprudencia_tj.download_tj_ESAJ(c,crawler_jurisprudencia_tj,'','',termo='socio OU sociedade OU societario NAO penal NAO criminal')
