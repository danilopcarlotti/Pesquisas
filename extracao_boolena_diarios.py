...
dic_expressoes = {
    ...
    'regime_semiaberto':[r'fixo.{,50}o\s*?regime\s*?semiaberto|ser\s*?cumprida\s*?no\s*?regime\s*?semiaberto'],
    'regime_aberto':[r'fixo.{,50}o\s*?regime\s*?aberto|ser\s*?cumprida\s*?no\s*?regime\s*?aberto|alterar\s*?o\s*?regime\s*?inicial\s*?para\s*?o\s*?aberto'],
    'regime_fechado':[r'Fixo.{,50}o regime inicial fechado|ser\s*?cumprida\s*?no\s*?regime\s*?aberto'],
    'deferimento_indulto':[r'DECLARO\s*?INDULTADA.{,20}pena|[\s,]defiro.{,40}indulto'],
    'indeferimento_liminar':[r'Indefiro.{,30}liminar|Não\s*?havendo\s*?como\s*?ser\s*?concedida\s*?a\s*?liminar|indeferida\s*?a\s*?liminar'],
    ...
    'concessão_liberdade_provisória':[r'CONCEDO.{,100}liberdade provisória|[\s,]defiro.{,100}liberdade provisória'],
    'não_concessão_liberdade_provisória':[r'indefiro.{,100}liberdade provisória'],
    'afastar_tráfico_privilegiado':[r'para\s*?afastar\s*?o\s*?tráfico\s*?privilegiado'],
    'privilegiado_hediondo':[r'consider.{,30}tráfico\s*?privilegiado.{,30}equiparado\s*?a\s*?hediondo']
}
