...
def csv_base(filepath):
	...
	for _, row in df.iterrows():
		...
		if re.search(r'previdenciário|inss|instituto nacional.{1,5}seguro social|previdência',row['texto_publicacao'].lower(),flags=re.DOTALL|re.I):
			cursor.execute('INSERT INTO previdenciario.extracao (nCnj, texto_publicacao) VALUES ("%s","%s")' % (row['numero_processo'], row['texto_publicacao'].replace('\n',' ').replace('"','').replace('\\','')))
...
if __name__ == '__main__':
	path_diarios = ['/home/deathstar/Documents/Diarios/Diarios_trf1','/home/deathstar/Documents/Diarios/Diarios_trf3',
	'/home/deathstar/Documents/Diarios/Diarios_trf4','/home/deathstar/Documents/Diarios/Diarios_trf5']
